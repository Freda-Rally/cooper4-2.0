package org.freda.cooper4.core.configs.datasource;
...
/**
 * druid filter configuration.
 *
 *
 *
 * Created by rally on 2017/4/19.
 */
@Configuration
public class DruidFilterConfiguration implements EnvironmentAware
{
    ...
    public Log4jFilter logFilter()
    {
        ...
        logFilter.setStatementExecutableSqlLogEnable(Boolean.parseBoolean(propertyResolver.getRequiredProperty("log.statementExecuteAfterLogEnabled")));

        logFilter.setStatementExecuteAfterLogEnabled(Boolean.parseBoolean(propertyResolver.getRequiredProperty("log.statementExecuteAfterLogEnabled")));

        logFilter.setStatementExecuteBatchAfterLogEnabled(Boolean.parseBoolean(propertyResolver.getRequiredProperty("log.statementExecuteBatchAfterLogEnabled")));

        logFilter.setStatementExecuteQueryAfterLogEnabled(Boolean.parseBoolean(propertyResolver.getRequiredProperty("log.statementExecuteQueryAfterLogEnabled")));

        logFilter.setStatementExecuteUpdateAfterLogEnabled(Boolean.parseBoolean(propertyResolver.getRequiredProperty("log.statementExecuteUpdateAfterLogEnabled")));
